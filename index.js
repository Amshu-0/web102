...
const displayStr = countUnfundedGames == 1 ?
...
: `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${countUnfundedGames} game remains unfunded.We need your help to fund these amazing games.`  

// create a new DOM element containing the template string and append it to the description container
const displayString = document.createElement('div')
displayString.innerHTML = `<p>${displayStr}</p>`
